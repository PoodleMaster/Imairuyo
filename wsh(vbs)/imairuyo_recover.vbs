' メッセージボックス表示
MsgBox "recover start", vbInformation, "Check point"
...
MsgBox "Terminated process start", vbInformation, "Check point"
...
If fso.FileExists(lockFilePath) Then
    ...
    MsgBox "Lock file deleted.", vbInformation, "Lock File Deleted"
Else
    MsgBox "Lock file not found.", vbExclamation, "Lock File Missing"
End If
